...
function RegisterFlow({ t, lang, onClose }) {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      const res = await fetch("https://movfynswogmookzcjijt.supabase.co/functions/v1/voku-chat", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          system: systemPrompt,
...
export default function VokuLanding() {
  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", background: "#F8F8F6", color: "#111", overflowX: "hidden" }}>
      <NoiseTexture />
