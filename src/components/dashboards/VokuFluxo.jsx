...
const COLORS_LIGHT = {
  bg: "#F5F4F0", surface: "#FFFFFF", card: "#EFEFEB", border: "#D8D5CE",
  accent: "#5A7A00", accentDim: "#4A6800", text: "#1A1A18", muted: "#888880",
  dim: "#C8C5BE", claude: "#7C6FCD", claudeLight: "#5A4FAD",
  supabase: "#0A9960", vercel: "#111111", resend: "#CC3300",
  fiverr: "#128A50", workana: "#CC4A10", stripe: "#3D35CC", google: "#1A5FCC",
};

export default function VokuFlow() {
  const [dark, setDark] = useState(true);
  const C = dark ? COLORS : COLORS_LIGHT;
      ...
      >
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <span style={{ color: C.accent, fontSize: 22, fontWeight: 700 }}>✦ VOKU</span>
            <span style={{ color: C.muted, fontSize: 12 }}>—</span>
            <span style={{ color: C.muted, fontSize: 12, letterSpacing: "0.1em" }}>
              FLUXO OPERACIONAL
            </span>
          </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div
            style={{
              background: C.claude + "22",
              border: `1px solid ${C.claude}44`,
              color: C.claudeLight,
              borderRadius: 6,
              padding: "6px 14px",
              fontSize: 11,
          ...
          <div style={{ position: "relative" }}>
            ...
            <div
              style={{
                ...
                bottom: 20,
                width: 1,
                background: `linear-gradient(to bottom, ${C.accent}44, ${C.claude}44, ${C.supabase}44)`,
              }}
            />
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      height: 56,
                      borderRadius: "50%",
                      background: isActive ? step.color + "22" : C.card,
                      border: `1.5px solid ${isActive ? step.color : C.border}`,
                      display: "flex",
                      alignItems: "center",
                  ...
                  <div
                    style={{
                      ...
                      border: `1px solid ${isActive ? step.color + "55" : C.border}`,
                      borderRadius: 8,
                      padding: "14px 20px",
                      transition: "all 0.2s",
                    }}
                  ...
                  {isActive && (
                    ...
                    >
                      <div>
                        ...
                        <div style={{ fontSize: 11, color: C.text }}>{p.subscription}</div>
                      </div>
                      <div>
                        <div
                          style={{
                        ...
                        <div style={{ fontSize: 11, color: C.text }}>{p.when}</div>
                      </div>
                    </div>
                  )}

                  {!isActive && (
                    <div style={{ fontSize: 10, color: C.muted }}>{p.subscription}</div>
                  )}
                </div>
              );
            })}
        ...
        <div style={{ marginTop: 64 }}>
          ...
          >
            {[
              ...
              >
                <span style={{ color: C.text, fontWeight: 600 }}>{row.plat}</span>
                <span
                  style={{
                    color: row.cost === "Já pago" ? C.supabase : C.accent,
                    fontWeight: 700,
                  }}
                >
                  {row.cost}
            ...
            >
              <span style={{ color: C.accent, fontWeight: 700, fontSize: 13, letterSpacing: "0.05em" }}>
                CUSTO FIXO MENSAL DO MVP
              </span>
              <span style={{ color: C.accent, fontWeight: 700, fontSize: 18 }}>$0</span>
            </div>
          </div>
            ...
            {[
              ...
              >
                ...
                {[
                  ...
                  >
                    <span style={{ color: C.muted, letterSpacing: "0.08em" }}>{row.label}</span>
